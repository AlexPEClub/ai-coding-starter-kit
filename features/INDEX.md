...
| PROJ-35 | Arbeitsvorbereitung — Werkzeugkategorien & Pfade (Stammdaten) | 🟢 Approved — Admin-Stammdaten: Ober-/Unterkategorien, globales Geometrie-Parameter-Register, automatische Serviceartikel-Zuordnung über Preisstaffel (zweistufig: Checkbox-Kandidatenauswahl, dann Wertebereich je Kandidat), wiederverwendbare Pfade (Ort im Betrieb/extern) inkl. manueller Dienstleister-Anlage (`partner_type='supplier'`). QA-Runde 1 fand 6 Bugs (2 High: Serviceartikel-Neuanlage/`products.id` ohne Default, PostgREST-Filter-Injection aus PROJ-28 neu erreichbar; 2 Medium: "Einsatzbereit"-Prüfung, Parameter-Register ohne Deaktivierung; 2 Low), auf User-Wunsch alle 6 gefixt (Migration `20260729180000_PROJ-35_bugfixes.sql` + Code) und einzeln gegen die Live-DB re-verifiziert. tsc/lint/tests/build grün, 15/15 Acceptance Criteria grün. Baut auf PROJ-34/28 auf. Teil 2a/7. Details in `features/PROJ-35-werkzeugkategorien-pfade-stammdaten.md`. Nächster Schritt: `/deploy PROJ-35` | 2026-07-29 |
