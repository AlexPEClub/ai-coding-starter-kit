...
|----|---------|----------|--------|------|--------------|---------|
| PROJ-1 | Supabase Multi-Tenant Infrastructure | P0 | Planned | [Spec](PROJ-1-supabase-multi-tenant-infrastructure.md) | None | 2026-05-28 |
...
| PROJ-6 | Kunde-Portal (Basis-UI) | P0 | Roadmap | — | PROJ-16 | 2026-05-28 |
