...
"Frontend Developer" delegiert (Modell fest auf Haiku gepinnt, siehe
`.claude/agents/frontend-dev.md` — spart Kosten bei der Umsetzung).

Rufe das Agent-Tool auf: `subagent_type: "Frontend Developer"`, Prompt enthält
